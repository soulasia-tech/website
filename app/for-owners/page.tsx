            ...
            <div className="bg-white">
                    ...
                    <div className="container relative">
                        ...
                        <motion.div
                            ...
                            <div
                                ...
                                <h2 className="h2 font-semibold text-[#dfdfdf]">We will help you rent your
                                    apartment</h2>
                                <div
                                    className="font-normal text-[#dfdfdf] text-sm tb:text-base lg:text-lg full:text-2xl">
                ...
                rounded-xl tb:rounded-2xl lp:rounded-3xl ">
                            ...
                            >
                                ...
                                <div
                                    className="text-[#dfdfdf] drop-shadow-md font-normal text-base tb:text-lg lp:text-xl full:text-2xl mb-4 max-w-70 tb:max-w-120">
                                    We care for your property as if it were our own.
                                </div>
                            </motion.div>
                            <motion.div
