        ...
        <>
            ...
            <div className="flex flex-col min-h-screen bg-white pt-0 -mt-nav">
                ...
                <section
                    ...
                    <div className="container relative z-10 flex flex-col items-center justify-center text-center">
                        ...
                        >
                            ...
                            <div
                                className="text-white font-normal text-sm tb:text-xl lp:text-2xl full:text-[32px] w-4/5 mx-auto">
                                Premium serviced apartments in Kuala Lumpur for families, couples, and business
                                travelers
                            </div>
                ...
                <main className="flex-1 pt-0">
                    ...
                    {/* Hero Section */}
                    <section className="my-0 tb:my-12.5 lp:my-20 full:my-25 bg-white relative mx-0 tb:mx-2">
                        <div
                        ...
                        <motion.div
                            ...
                            <div
                                ...
                                <div
                                    className="font-normal text-[#dfdfdf] max-w-120 text-sm tb:text-base lg:text-lg full:text-2xl">
                                ...
                                <a href="/for-owners"
                                   className="font-medium text-white text-base full:text-xl underline">
                                    Read More
                                </a>
                            </div>
                            ...
                            <motion.div
                                ...
                                <div className="lp:w-1/2 flex flex-col gap-6 tb:gap-10 full:gap-15">
                                    <div className="flex flex-col gap-2.5 lp:gap-4">
                                        ...
                                        <h2 className="h2 text-white font-semibold mb-2">Apartments to International
                                            Standards</h2>
                                        <div
                                            className="font-normal text-white text-base tb:text-lg lp:text-xl full:text-2xl mb-4 max-w-fit pr-4">
                                            We manage apartments in Kuala Lumpur according to Blueground international
                                            standards.
                                        </div>
                                    </div>
                                        ...
                                        {[
                                            ...
                                            >
                                                <div className="flex max-w-fit items-start gap-2.5 tb:gap-5">
                                                    <div
                                                        className="flex items-center justify-start aspect-[1/1] w-[24px] tb:w-[34px] h-[24px] tb:h-[34px]">
                                                        <Image
                                                            src={item.iconSrc} alt={item.title}
                    ...
                    <section className="section-padding-y relative overflow-hidden ">
                        <div className="absolute inset-0 w-full h-full z-0 pointer-events-none bg-[#F9FAFB]"
                             aria-hidden="true"/>
                            ...
                            <div className="flex justify-between header-margin-b">
                                <div className="max-w-lg text-left ">
                                    ...
                                    <div
                                        ...
                                        every where — thoughtful amenities, seamless technology, and a welcoming
                                        atmosphere in every
                                        location
                                    </div>
                                </div>
