            ...
            >
              ...
              <AccordionItem value="section-1">
                ...
                <AccordionContent className="space-y-3">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>
                      <strong>Registered address:</strong> B1-22-2, The Soho Suites @KLCC, 20 Jalan
                      Perak, 50450, WP Kuala Lumpur, Malaysia
                    </li>
                    <li>
                      <strong>Trading name:</strong> &quot;Soulasia&quot; is a registered trademark
              ...
              <AccordionItem value="section-2">
                ...
                <AccordionContent className="space-y-3">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>
                      Individuals who make an enquiry or booking with us directly or via third-party
                      platforms;
                    </li>
                ...
                <AccordionContent className="space-y-4">
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      ...
                      <li>
                        <strong>Travel and identification details:</strong> passport or ID number,
                        passport or ID photo/scan, nationality or country of residence, date of
                        birth (where required).
                      </li>
                      <li>
                        <strong>Booking and stay information:</strong> property booked, check-in and
                        check-out dates, number of guests and guest names (where provided), special
                        requests or preferences (e.g. late check-in, early check-in, allergies, or
                        other details you choose to share).
                      </li>
                      <li>
                        <strong>Payment and billing information:</strong> payment method details
                        (such as partial card details or transaction identifiers), billing address
                        (where applicable), deposit and refund details.
                      </li>
                      <li>
                        <strong>Corporate/partner information:</strong> company name and business
                        contact details, job title or role, and information relating to property or
                        partnership agreements.
                      </li>
                    </ul>
                    <p className="mt-3">
                      We generally use third-party payment service providers to process payments. We
                    ...
                    <p className="mt-2">
                      ...
                      be able to provide some services (for example, we may not be able to complete
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      ...
                      <li>
                        Corporate clients or relocation partners who make a booking on your behalf;
                      </li>
                      <li>
                        Payment service providers who process your payments and confirm transaction
                        status;
                      </li>
                      <li>Identity verification and deposit/security providers;</li>
                      <li>
                        Property owners, landlords and building management in relation to your stay;
                      </li>
                      <li>
                    ...
                    <p className="mt-3">
                      We handle this information in accordance with this Privacy Policy, in addition
                ...
                <AccordionContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      ...
                      <li>
                        Send booking confirmations, pre-arrival messages, check-in instructions and
                        receipts;
                      </li>
                      <li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      ...
                      <li>
                        Send newsletters or promotional messages where you have subscribed or where
                        permitted by law;
                      </li>
                      <li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      ...
                      <li>
                        Generating reports and business analytics (e.g. occupancy, revenue, guest
                        trends);
                      </li>
                      <li>Fraud prevention, risk management and security monitoring;</li>
                      <li>
                        Protecting our guests, staff, properties, systems and business interests.
                      </li>
                    </ul>
                  </div>
                </AccordionContent>
              ...
              <AccordionItem value="section-5">
                ...
                <AccordionContent className="space-y-3">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>
                      <strong>Compliance with legal obligations:</strong> to comply with applicable
                      laws and regulations (for example, immigration, tax, accounting and reporting
                    ...
                    <li>
                      ...
                      complaints, run analytics and conduct marketing activities in a proportionate
              ...
              <AccordionItem value="section-6">
                ...
                <AccordionContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      We work with third-party companies that assist us in delivering our services,
                      for example:
                    </p>
                    <ul className="list-disc list-inside mt-2 space-y-1">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      We may share relevant information with property owners or building management
                      where necessary for your stay, security and compliance; corporate clients or
                      relocation partners who booked on your behalf; and other partners involved in
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      If Soulasia is involved in a merger, acquisition, restructuring, asset sale or
              ...
              <AccordionItem value="section-8">
                ...
                <AccordionContent className="space-y-3">
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    ...
                    <li>
                      <strong>Marketing-related data (e.g. newsletter subscriptions):</strong> kept
              ...
              <AccordionItem value="section-9">
                ...
                <AccordionContent className="space-y-3">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>
                      Limiting access to personal data to authorised staff and service providers who
              ...
              <AccordionItem value="section-10">
                ...
                <AccordionContent className="space-y-3">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Right of access</strong> – to request confirmation whether we process
                    ...
                    <li>
                      <strong>Right to object</strong> – to object to certain processing, including
                      direct marketing.
                    </li>
                    <li>
