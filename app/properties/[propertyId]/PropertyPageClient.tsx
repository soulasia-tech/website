...
export default function PropertyPageClient() {
    ...
    const mapPosition = propertyLocationMap[String(propertyId)];
                        ...
                        <div className="flex flex-col lp:flex-row lp:justify-between gap-2">
                            ...
                            <div className="flex tb:space-y-0 items-center gap-1 lp:gap-3 text-sm text-[#4A4F5B]">
                                <div className="flex items-center gap-1">
                                    ...
                                    />
                                    <span
                                        className="text-xs tb:text-sm lp:text-base">{property?.metadata?.bedroom}</span>
                                </div>
                                <div className="flex items-center gap-1">
                                    <Image
                                    ...
                                    />
                                    <span
                                        className="text-xs tb:text-sm lp:text-base">{property?.metadata?.bathroom}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div className="col-span-1 lg:col-span-2 space-y-6">
                                ...
                                {property?.amenities?.map((amenity, idx) => (
                                    <li key={idx} className="flex items-center gap-2 tb:gap-3 lp:gap-5">
                                        <Image src={amenity?.icon ?? ''} alt="Soulasia Logo White"
                                               className="aspect-[1/1] w-4 tb:w-6 lp:w-8 full:w-10" width={40}
                                               height={40} priority/>
                                        <span
                                            className="font-normal text-sm tb:text-xl full:text-2xl">{amenity.label}</span>
                                    </li>
                                ))}
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            {!loading ? (<Rooms propertyId={propertyId} placeHint={property?.metadata?.placeHint}
                                                rooms={rooms}/>) :
                    ...
                    <div className="col-span-1 w-full flex-shrink-0">
                        <div className="lp:sticky lp:top-[calc(var(--nav-h)*2)]">
                            <div
                                className="flex flex-col bg-[#f9fafb] rounded-xl max-w-full p-6 ">
                                <div className="font-semibold text-black text-xl tb:text-2xl mb-4 tb:mb-5">Search
                                    apartments
                                </div>
                                <form className="flex flex-col gap-4" onSubmit={handleBookNow}>
                                                    ...
                                                    {selectedDates?.from && selectedDates?.to
                                                        ...
                                                        : (
                                                            <div className="flex gap-3 items-center">
                                                                <Image
                                                                    src="/icons/calendar.svg" alt=""
                                                                    className="aspect-[1/1] w-4 tb:w-6"
                                                                    width={24}
                                                                    height={24}
                                                                />
                                                                <div
                                                                    className="font-normal text-xs tb:text-s text-[#4a4f5b]">Pick
                                                                    dates
                                                                </div>
                                                            </div>
                                                        )
                                    ...
                                    <div
                                        className={["flex items-center bg-white border border-[#DEE3ED] rounded-lg px-3",
                                            "h-[var(--action-h-lg)] tb:h-[var(--action-h-3xl)]"].join(' ')}
                                    >
                                        <div className="flex items-center justify-between w-full gap-6">
                                            <div className="flex gap-3 items-center">
                                                <Image
                                                    ...
                                                    height={24}
                                                />
                                                <div className="font-normal text-xs tb:text-s text-[#4a4f5b]">Adults
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex items-center w-full justify-between">
                                            <div className="flex gap-3 items-center">
                                                <Image
                                                    ...
                                                    height={24}
                                                />
                                                <div className="font-normal text-xs tb:text-s text-[#4a4f5b]">Children
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2 tb:gap-4">
                                                <Button type="button" size="responsive" variant="outline"
                                    ...
                                    >
                                        <div className="flex items-center w-full justify-between">
                                            <div className="flex gap-3 items-center">
                                                ...
                                                />
                                                <div
                                                    className="font-normal text-xs tb:text-s text-[#4a4f5b]">Apartments
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2 tb:gap-4">
                                                <Button type="button" size="responsive" variant="outline"
...
function Rooms({propertyId, placeHint, rooms}: {
    propertyId: string,
    placeHint?: string,
