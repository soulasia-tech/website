                        ...
                        <div className="space-y-6">
                            ...
                            <section>
                                ...
                                <p className="text-gray-600">
                                    Refunds will be processed within 5-10 business days after approval. The time taken
                                    for the refund
                                    to reflect in your account may vary depending on your payment method and financial
                                    institution.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-gray-600">
                                    A processing fee of 3% of the total booking amount applies to all refunds to cover
                                    transaction
                            ...
                            <section>
                                ...
                                <p className="text-gray-600">
                                    In cases of unexpected events such as natural disasters, medical emergencies (with
                                    proper
                                    documentation), or other extraordinary circumstances, we may consider full refunds
                                    on a
                                    case-by-case basis.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-gray-600">
                                    If you fail to check in on your scheduled arrival date without prior notice, this
                                    will be
                            ...
                            <section>
                                ...
                                <p className="text-gray-600">
                                    No refunds will be provided for early departure or unused nights once you have
                                    checked in.
                            ...
                            <section>
                                ...
                                <p className="text-gray-600">
                                    Refunds will be issued to the original payment method used for the booking. We
                                    cannot
