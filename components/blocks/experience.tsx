            ...
            <div className="container mx-auto">
                ...
                >
                    <div className="max-w-md lp:max-w-xl text-left mb-2 mr-auto">
                        ...
                        <div
                            className="font-normal text-[#3b4a68] text-lg lp:text-xl full:text-2xl mt-2">{description}</div>
                    </div>
                ...
                >
                    ...
                    >
                        {items.map((item) => (
                            ...
                            >
                                <div
                                    className="relative w-full aspect-[4/3] lp:aspect-[3/2] h-[200px] tb:h-[250px] full:h-[364px]">
                                    <Image
                                        src={item.image}
                                        alt={item.title}
                                        fill
