                ...
                <div className="header-margin-b">
                    ...
                    >
                        ...
                        <div className="flex gap-x-[10px] items-center">
                            <a href="/all-locations" className="whitespace-nowrap text-sm tb:text-base lp:text-lg">See
                                all</a>
                            <div onClick={prev}
                                ...
                                <div className="">
                                    ...
                                    <div
                                        ...
                                        <div className="flex items-center gap-1">
                                            ...
                                            />
                                            <span
                                                className="text-xs tb:text-sm lp:text-base">{item.metadata.bedroom}</span>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            <Image
                                            ...
                                            />
                                            <span
                                                className="text-xs tb:text-sm lp:text-base">{item.metadata.bathroom}</span>
                                        </div>
                                    </div>
                                </div>
                                <a
