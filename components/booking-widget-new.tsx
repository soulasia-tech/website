...
export function BookingWidgetNew({
    ...
    const widgetContent = (
        ...
        >
            {/* City & Dates Group */}
            <div
                className="w-full flex justify-center grid grid-cols-1 tb:grid-cols-3 lp:grid-cols-[1fr_280px_280px] gap-2 ">
                                    ...
                                    >
                                        <div className="flex items-center w-[16px] h-[16px] lp:w-[20px] lp:h-[20px]">
                                            <Image
                                                ...
                                                className="w-full h-full text-[#0E3599]"
                                                width={24}
                                                height={24}
                                            />
                                        </div>
                            ...
                            <div className="space-y-3 lp:space-y-6">
                                <div className="flex w-max-content items-center justify-between gap-15">
                                    <div>
                                        ...
                                        <div className="font-normal text-[10px] lp:text-xs text-[#4a4f5b]">Ages 18 or
                                            above
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <div className="font-normal text-[10px] lp:text-xs text-[#4a4f5b]">Ages 3-17
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <Button type="button" size="responsive" variant="outline"
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        <div className="font-semibold text-xs lp:text-base text-[#101828]">Apartments
                                        </div>
                                        <div className="font-normal text-[10px] lp:text-xs text-[#4a4f5b]">Number of
                                            apartments
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2">
