...
export function BookingWidget({initialSearchParams, alwaysSticky, stickyMode, hide}: BookingWidgetProps) {
    ...
    if (isMobile && isExpanded) {
        ...
        return (
            <div className="fixed inset-0 z-50 bg-white/100 overflow-y-auto flex flex-col px-4 py-6"
                 style={{maxWidth: '100vw', background: '#fff', paddingTop: '80px'}}>
                ...
                >
                    ...
                    {/* Guests & Apartments */}
                    <div>
                        <label className="block text-xs font-semibold text-gray-700 mb-2 text-left">Guests &
                            Apartments</label>
    ...
    const widgetContent = (
        ...
        >
            ...
            >
                {/* City & Dates Group */}
                <div
                    className="w-full md:flex-[2] md:px-8 md:py-3 flex flex-col md:flex-row gap-2 md:gap-8 justify-center">
                    <div
                        className="flex-1 bg-gray-50 md:bg-transparent rounded-lg md:rounded-none shadow-sm md:shadow-none p-4 md:p-0 mb-2 md:mb-0">
                        <label
                            className="block text-xs md:text-sm font-semibold md:font-medium text-gray-700 mb-2 md:mb-1 text-left">City</label>
                        <Select
                            value={searchParams.city}
                            onValueChange={handleCityChange}
                            disabled={loading}
                    ...
                    <div
                        className="w-full md:w-[220px] md:max-w-[260px] bg-gray-50 md:bg-transparent rounded-lg md:rounded-none shadow-sm md:shadow-none p-4 md:p-0 mb-2 md:mb-0">
                        <label
                            className="block text-xs md:text-sm font-semibold md:font-medium text-gray-700 mb-2 md:mb-1 text-left">Dates</label>
                        <Popover
                            open={datePopoverOpen}
                            onOpenChange={(open) => {
                                setDatePopoverOpen(open);
                ...
                {/* Guests Group */}
                <div
                    className="w-full md:flex-[2] md:px-6 md:py-3 flex flex-col md:flex-row gap-2 md:gap-8 justify-center">
                    <div
                        className="flex-1 md:basis-48 md:max-w-[200px] bg-gray-50 md:bg-transparent rounded-lg md:rounded-none shadow-sm md:shadow-none p-4 md:p-0 mb-2 md:mb-0">
                        <label className="block text-xs md:text-sm font-medium text-gray-800 mb-1 text-left">Add
                            guests</label>
                        <Popover open={guestsPopoverOpen} onOpenChange={setGuestsPopoverOpen}>
                            <PopoverTrigger asChild>
                                <Button
