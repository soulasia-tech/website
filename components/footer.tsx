...
export function Footer() {
  return (
    <footer className="text-white pt-8 pb-4" style={{ backgroundColor: '#112362' }}>
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          <div>
            ...
            <div className="flex space-x-2 mt-2">
              <a href="https://www.instagram.com/soulasia.com.my" target="_blank" rel="noopener noreferrer">
                <Button variant="ghost" size="icon" className="rounded-full bg-gray-800 hover:bg-gray-700 p-1" style={{ width: 32, height: 32 }}>
          ...
          <div>
            ...
            <p className="text-xs mb-1" style={{ color: '#fff' }}>
          ...
          <div>
            <ul className="space-y-1">
              ...
              <li>
                <Link href="/refund-policy" className="text-xs text-gray-400 hover:text-white">
                  Refund Policy
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-4 text-center text-xs">
          <p style={{ color: '#fff' }}>© {new Date().getFullYear()} Soulasia. All rights reserved.</p>
          <div className="mt-1">
