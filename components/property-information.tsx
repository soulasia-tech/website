        ...
        <section className="w-full">
            <div className="w-full px-0 mx-0">
                ...
                <div className="mb-6 gap-2 space-y-3 lp:space-y-5">
                    <h2 className="h2 font-semibold text-[#101828] ">
                        {property.propertyName ? `${property.propertyName} Information` : 'Property Information'}
                    </h2>
                </div>
                ...
                <div className="flex flex-col gap-5">
                    ...
                    {amenities.length > 0 && (
                        <div className="flex flex-col gap-2.5 tb:gap-5 text-[#101828]">
                            <h2 className="text-[calc(var(--fs-h2)-4px)] font-semibold ">Amenities</h2>
                            <ul className="grid grid-cols-2 lp:grid-cols-3 gap-5">
                                    ...
                                    return (
                                        <li key={idx} className="flex items-center gap-2 tb:gap-3 ">
                                            <Image src={srcIcon} alt=""
                                                   className="flex justify-center aspect-[1/1] w-4 tb:w-6 lp:w-8"
                                                   width={40}
                                                   height={40} priority/>
                                            <span
                    ...
                    <div className="flex flex-col gap-2.5 tb:gap-5">
                        <div className="gap-1 tb:gap-2.5 items-start">
                            <h2 className="text-[calc(var(--fs-h2)-4px)] font-semibold ">Address & Contact</h2>
                            {address && (
                                <div className="text-sm tb:text-lg text-[#4a4f5b] font-normal">
                    ...
                    {(checkIn || checkOut) && (
                        <>
                            <div className="border border-[#dee3ed]"></div>
                            <div>
                                <h2 className="text-[calc(var(--fs-h2)-4px)] font-semibold ">Check-In & Check-Out</h2>
                    ...
                    {policies.length > 0 && (
                        <>
                            <div className="border border-[#dee3ed]"></div>
                            <div>
                                <h2 className="text-[calc(var(--fs-h2)-4px)] font-semibold ">Property & Cancellation
                                    Policies</h2>
                    ...
                    {terms && (
                        <>
                            <div className="border border-[#dee3ed]"></div>
                            <div>
                                <h2 className="text-[calc(var(--fs-h2)-4px)] font-semibold ">Terms & Conditions</h2>
